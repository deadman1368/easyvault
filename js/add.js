...
(function(){
  ...
  try{
    ...
    checkUsername = document.querySelector("input[name='login']");
    checkPwd = document.querySelector("input[name='password']");

    try{

      fillUsername = document.querySelector("input[name='login']").value;
      fillPwd =  document.querySelector("input[name='password']").value;

      console.log('login page: ',localStorage.counterValue);
